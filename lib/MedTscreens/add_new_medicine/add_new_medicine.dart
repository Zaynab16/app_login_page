...
import 'package:app_login_page/helpers/snack_bar.dart';
import 'package:app_login_page/models/medicine_type.dart';
import 'package:app_login_page/models/pill.dart';

import '../../helpers/platform_flat_button.dart';
import '../../MedTscreens/add_new_medicine/form_fields.dart';
import '../../MedTscreens/add_new_medicine/medicine_type_card.dart';
...
class _AddNewMedicineState extends State<AddNewMedicine> {
  ...
  Future<void> initNotifies() async {
    flutterLocalNotificationsPlugin = FlutterLocalNotificationsPlugin();
    //await _notifications.initNotifies(flutterLocalNotificationsPlugin);
    await _notifications
        .initNotifies(context); //, flutterLocalNotificationsPlugin);
  }
  ...
  Future savePill() async {
    ...
    if (setDate.millisecondsSinceEpoch <=
      ...
      snackbar.showSnack(
        "Check your medicine time and date",
        _scaffoldKey,
        () {},
      );
    } else {
