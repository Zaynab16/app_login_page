...
import 'package:app_login_page/MedTscreens/add_new_medicine/slider.dart';

class FormFields extends StatelessWidget {
  final List<String> weightValues = ["pills", "ml", "mg"];
  final int howManyWeeks;
  final String selectWeight;
  //final Function(dynamic) onPopUpMenuChanged, onSliderChanged;
  final void Function(String) onPopUpMenuChanged;
              ...
              Flexible(
                ...
                child: Container(
                  ...
                  child: DropdownButtonFormField<String>(
                    ...
                    items: weightValues
                        .map(
                          (weight) => DropdownMenuItem<String>(
                        child: Text(weight),
                        value: weight,
                      ),
                    )
